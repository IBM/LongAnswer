...
class SummarizationTrainer(BaseTransformer):
    ...
    def forward(self, input_ids, attention_mask=None, decoder_input_ids=None, lm_labels=None, roberta_emb=None):
        return self.model(
    ...
    def _step(self, batch):
        ...
        source_ids, source_mask, y, roberta_emb = batch["source_ids"], batch["source_mask"], batch["target_ids"], batch["roberta_embeddings"]
